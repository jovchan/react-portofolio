...
export default function List() {
  ...
  return (
    ...
    >
      <Animasi>
        <div className="flex flex-col lg:flex-row m-6 gap-4 items-center">
          ...
          <div className="keterangan w-full text-secondary lg:w-1/2 flex flex-wrap items-center text-7xl xl:text-9xl sm:text-8xl m-auto">
            ...
            <span className="text-accent mr-8 dark:text-abu-putih ">.001</span> GAMING GEAR
            <p className="courier text-neutral dark:text-primary text-xl xl:text-2xl 2xl:text-3xl mt-0">
      ...
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent dark:border-abu-putih mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/80 dark:border-abu-putih/80 mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/60 dark:border-abu-putih/60 mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/40 dark:border-abu-putih/40 mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-4 sm:border-b-8 border-accent/20 dark:border-abu-putih/20 mx-6 opacity-0 fade-in2"></div>
      <Animasi>
        <div className="flex flex-col lg:flex-row m-6 gap-4 items-center md:hidden">
          ...
          <div className="keterangan w-full text-secondary lg:w-1/2 flex flex-wrap items-center text-7xl xl:text-9xl sm:text-8xl m-auto">
            ...
            <p className="courier text-neutral dark:text-primary dark:text-abu-putih text-xl xl:text-2xl 2xl:text-3xl mt-0">
      ...
      <Animasi>
        <div className="flex flex-col lg:flex-row m-6 gap-4 items-center">
          ...
          <div className="keterangan w-full text-secondary lg:w-1/2 flex flex-wrap items-center text-6xl xl:text-8xl sm:text-7xl m-auto">
            ...
            <span className="text-accent dark:text-abu-putih mr-8 ">.003</span> Sewakantor-update
            <p className="courier text-neutral dark:text-primary text-xl xl:text-2xl 2xl:text-3xl mt-2">
      ...
      <Animasi>
        <div className="flex flex-col lg:flex-row m-6 gap-4 items-center md:hidden">
          ...
          <div className="keterangan w-full text-secondary lg:w-1/2 flex flex-wrap items-center text-7xl xl:text-9xl sm:text-8xl m-auto">
            ...
            <span className="text-accent dark:text-abu-putih mr-8 ">.004</span> Work From Office
            <p className="courier text-neutral dark:text-primary text-xl xl:text-2xl 2xl:text-3xl mt-2">
      ...
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/60 dark:border-abu-putih/60 mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/40 dark:border-abu-putih/40 mx-6 opacity-0 fade-in2"></div>
      <div className="hidden md:block border-b-2 sm:border-b-2 border-accent/20 dark:border-abu-putih/20 mx-6 opacity-0 fade-in2"></div>
    </div>
  );
}
